package com.cts.multidatabase.configuration;
...
@EnableJpaRepositories(basePackages = "com.cts.multidatabase.student.repository", entityManagerFactoryRef = "studentEntityManagerFactory", transactionManagerRef = "studentTransactionManager")
